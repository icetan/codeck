...
function(require,exports,module){
// Boiler file: node_modules/coffee-script-browser/index.js
/**
...
});register.call(this,3,{"../lib/three.min":1,"coffee-script-browser":2},
function(require,exports,module){
...
(function() {
  ...
  Patch = (function() {
    ...
    Patch.prototype.compile = function(code) {
      var js;
      js = csCompile(code, {
        bare: true
      });
    ...
    Patch.prototype.getCode = function() {
  ...
  createPatchContext = function(scene, camera) {
    ...
    context = {
      ...
      material: function(color, wf, vcolor) {
        return new THREE.MeshBasicMaterial({
          color: color,
          wireframe: wf,
          transparent: true,
          shading: THREE.FlatShading,
          vertexColors: (vcolor != null ? vcolor : false)
        });
      },
      icosphere: function(name, radius, seg, material) {
        var obj;
  ...
  module.exports = {
    Patch: Patch,
    createPatchContext: createPatchContext
  };

}).call(this);

});
register.call(this,4,{"./patch":3},
function(require,exports,module){
...
(function() {
  ...
  Loop = (function(_super) {
    ...
    Loop.prototype.mute = false;

    Loop.prototype.run = function(context) {
      if (!this.mute) {
...
});register.call(this,5,{"../lib/three.min":1,"./patch":3,"./loop":4},
function(require,exports,module){
...
(function() {
  ...
  CODECK = (function() {
    ...
    function CODECK(container) {
      var ASPECT, FAR, NEAR, VIEW_ANGLE, pointLight;
      this.shapes = {};
      this.patches = [];
      this.loops = [];
    ...
    CODECK.prototype.addPatch = function(patch) {
      this.patches.push(patch);
      return patch.run(this.patchContext);
    };

    CODECK.prototype.addLoop = function(codeLoop) {
      return this.loops.push(codeLoop);
    };

    CODECK.prototype.render = function() {
...
register.call(this,6,{"../lib/three.min":1,"./codeck":5,"./patch":3,"./loop":4},
function(require,exports,module){
// Boiler file: js/test.coffee
(function() {
  var CODECK, Loop, Patch, THREE, loop1, mainLoop, mainPatch, patch1;
  ...
  module.exports = function(container) {
    ...
    this.codeck.addPatch(mainPatch);
    this.codeck.addLoop(mainLoop);
    return this.codeck.start();
  };

}).call(this);

});register.call(this,8,{"coffee-script":7,"./test":6},
function(require,exports,module){
// Boiler file: js/main
